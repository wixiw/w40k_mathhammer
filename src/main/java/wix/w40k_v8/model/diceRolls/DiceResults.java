...
/**
 * @author wix This class represent a dice roll result, under the form of a
...
public class DiceResults {
    ...
    public static final DiceResults D6_ROLL = new DiceResults(
	    new double[] { 1 / 6., 1 / 6., 1 / 6., 1 / 6., 1 / 6., 1 / 6. });
     ...
     * 
     * @param atLeast
     *            : the minimal (or equal) value that defines a success. Dice
     *            below that are rerolled
